            ...
            <div className="min-lg:h-screen flex flex-wrap gap-4 p-4">
                <div className="bg-orange-500 flex-1 p-6 flex flex-col justify-center gap-6 min-h-fit">
                    <div className="flex gap-3 items-center">
                        ...
                        <h4 className="text-2xl font-medium text-white">Colocado 🎉</h4>
                    </div>
                    <h2 className="text-3xl lg:text-6xl font-bold text-white lg:h-[180px]">{data[0].congregation.name}</h2>
                    <span className="px-3 py-8 bg-white/20 text-2xl font-medium text-white flex items-center justify-center">{roundToDecimalPlace(data[0].percentage, 1)}% de presença dos membros</span>
                </div>
                <div className="bg-zinc-900 flex-1 p-6 flex flex-col gap-6 justify-center min-h-fit">
                    ...
                    <span className="px-3 py-8 bg-white/20 text-2xl font-medium text-white flex items-center justify-center">{roundToDecimalPlace(data[1].percentage, 1)}% de presença dos membros</span>
                </div>
                <div className="bg-red-500 flex-1 p-6 flex flex-col gap-6 justify-center min-h-fit">
                    ...
                    <span className="px-3 py-8 bg-white/20 text-2xl font-medium text-white flex items-center justify-center">{roundToDecimalPlace(data[2].percentage, 1)}% de presença dos membros</span>
                </div>
            </div>
