...
export default async function ChurchPage() {
    return (
        <>
            <div className="w-full max-w-7xl px-3 mx-auto">
                <video autoPlay={true} loop={true} className="object-cover max-xl:h-screen">
                    <source src="/assets/historia.mov" />
                </video>
            </div>
            <div className="flex-1 flex flex-col gap-6 w-full max-w-[800px] px-3 mx-auto lg:py-4 mb-6">
