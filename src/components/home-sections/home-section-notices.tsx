...
export function HomeSectionNotices({notices}) {
    return (
        <section className="bg-background-aux min-min-h-[400px] py-10">
          <section className="h-full flex flex-col justify-center items-center gap-6 w-full max-w-7xl px-3 mx-auto">
            <h2 className="text-xl font-semibold text-white text-center uppercase">Últimas notícias</h2>
            {
            ...
            {notices.length > 0 && <Link href={'/'} className="h-10 min-w-[168px] border border-white text-white px-8 flex items-center justify-center">Veja mais</Link>}
          </section>
        </section>
    )
}